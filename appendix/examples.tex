...
% Pour les diagrammes d'échecs, le paquet \texttt{skak} est recommandé. Il permet de générer des diagrammes d'échecs à partir de notation FEN. Par exemple, la position de la figure \ref{echecs} est obtenue avec le code suivant :
...
\subsectinon{Filtrage}

Diagramme du troisième ordre d'un filtre à bruit dans un lecteur de compact disc par Grant M. Erickson.
