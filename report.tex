\documentclass[
    ...
    confidential, % Si le travail est confidentiel
]{heig-tb}
...
\begin{figure}[!ht]
    ...
    \end{center}
    \caption[Assemblage mécanique]{\label{assembly}Assemblage mécanique comportant 10. l'axe principal, 2.3 les o-ring d'étanchéité et 24. la butée de limitation. D'autres informations liées à la figure elle-même peuvent aussi figurer dans la légende}
\end{figure}

Notez que la légende est longue, ce n'est pas la même légende que vous retrouvez dans la table des figures. La commande \mintinline{latex}{\caption[courte]{longue}} permet de saisir une légende courte, pour la table des figures et longue pour le corps du document.
...
Si vous devez donner une spécification technique, n'oubliez pas de mentionner les valeurs minimales, maximales et nominales sans omettre l'unité de mesure.
...
Parfois, il est plus élégant d'annoter une définition en utilisant une note de bas de page \footnote{La note en bas de page (ou note de bas de page) est une forme littéraire, consistant en une ou plusieurs lignes ne figurant pas dans le texte.}. Alternativement il est possible d'annoter le paragraphe courant avec une note marginale. \maraja{Note marginale}
