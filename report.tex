...
\end{center}
\caption[Assemblage mécanique]{\label{assembly}Assemblage mécanique comportant 1. l'encoche latérale, 2. la plaque de base, 3. le bloc fonctionnel, 4. le système d'alignement, 5. l'obturateur, 6. le foyer et 7. l'alimentation}
\end{figure}
